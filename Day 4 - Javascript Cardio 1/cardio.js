// Get your shorts on - this is an array workout!
    ...
    const inventors = [
      ...
      const filteredFirst = inventors.filter(inventor => inventor.year >= 1500 && inventor.year < 1600)
      console.log("1. Filter the list of inventors for those who were born in the 1500's")
      console.table(filteredFirst)
      ...
      // 5. Sort the inventors by years lived
        const sortedInventorsLived = inventors.sort((a,b) => {
            const firstInventor = a.passed - a.year
            const secondInventor = b.passed - b.year

            if(firstInventor > secondInventor) return 1
            if(firstInventor < secondInventor) return -1
            if(firstInventor === secondInventor) return 0
        })  
        console.log("5. Sort the inventors by years lived")
        console.table(sortedInventorsLived)
      ...
      const summary = data.reduce((total, element) => {
